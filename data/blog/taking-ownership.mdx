...
draft: false
summary: "Taking ownership means going beyond completing coding tasks. Just like an artisan deeply cares about his work of art, when you take ownership, you'll naturally care for the product being made."
layout: PostSimple
---
...
Taking ownership means going beyond completing coding tasks. It means understanding the purpose of a certain feature or epic, being conscious of the value it brings for users and the project as a whole, and figuring out the best techniques and tools to implement it.
...
Come Monday and the PM just assigned you a task from a new epic or feature. You open the ticket, read the description, identify the acceptance criteria, and create a branch to start implementing. What did you do wrong?
